// ======================================================================
// 8x8DOT_Matrix.v generated from TopDesign.cysch
// 04/02/2021 at 13:13
...
module top ;
	...
	wire [7:0] tmpOE__Pin_1_net;
	wire [7:0] tmpFB_7__Pin_1_net;
	wire [7:0] tmpIO_7__Pin_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_1
		 (.oe(tmpOE__Pin_1_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__Pin_1_net[7:0]}),
		  .io({tmpIO_7__Pin_1_net[7:0]}),
	...
	assign tmpOE__Pin_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

	wire [7:0] tmpOE__Pin_2_net;
	wire [7:0] tmpFB_7__Pin_2_net;
	wire [7:0] tmpIO_7__Pin_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2_net;
	electrical [0:0] tmpSIOVREF__Pin_2_net;

	cy_psoc3_pins_v1_10
		#(.id("7ae8fabf-dc3a-4301-b33f-2ace4b57df83"),
		  .drive_mode(24'b110_110_110_110_110_110_110_110),
		  .ibuf_enabled(8'b1_1_1_1_1_1_1_1),
		  .init_dr_st(8'b0_0_0_0_0_0_0_0),
		  .input_clk_en(0),
		...
		Pin_2
		 (.oe(tmpOE__Pin_2_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__Pin_2_net[7:0]}),
		  .io({tmpIO_7__Pin_2_net[7:0]}),
	...
	assign tmpOE__Pin_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
