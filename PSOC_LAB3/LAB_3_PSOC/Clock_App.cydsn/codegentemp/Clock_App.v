// ======================================================================
// Clock_App.v generated from TopDesign.cysch
// 04/02/2021 at 22:14
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f05ef5db-42b3-488f-85c4-29a7211a46b7/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Set_Time_net;
	wire [0:0] tmpIO_0__Set_Time_net;
	electrical [0:0] tmpSIOVREF__Set_Time_net;
	...
	cy_psoc3_pins_v1_10
		...
		Set_Time
		 (.oe(tmpOE__Set_Time_net),
		  .y({1'b0}),
		  .fb({Net_27}),
		  .io({tmpIO_0__Set_Time_net[0:0]}),
		  .siovref(tmpSIOVREF__Set_Time_net),
		  .interrupt({Net_189}),
		  .annotation({Net_33}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__Set_Time_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5bda7b6e-6ff9-44ab-80d8-b367697c7775"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8e353568-aef2-42c4-a033-f74a4107c646"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a54c3e9b-b5ff-40ab-96b3-8affdc64fad9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
