// ======================================================================
// LCD_DisplaY.v generated from TopDesign.cysch
// 03/29/2021 at 18:04
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("c84803d2-079c-415e-9965-2392a41f22e5/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__LCD_A_net;
	wire [0:0] tmpFB_0__LCD_A_net;
	wire [0:0] tmpIO_0__LCD_A_net;
	wire [0:0] tmpINTERRUPT_0__LCD_A_net;
	electrical [0:0] tmpSIOVREF__LCD_A_net;
	...
	cy_psoc3_pins_v1_10
		...
		LCD_A
		 (.oe(tmpOE__LCD_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LCD_A_net[0:0]}),
		  .io({tmpIO_0__LCD_A_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_A_net),
		  .interrupt({tmpINTERRUPT_0__LCD_A_net[0:0]}),
		  .annotation({Net_1}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LCD_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LCD_K_net;
	wire [0:0] tmpFB_0__LCD_K_net;
	wire [0:0] tmpIO_0__LCD_K_net;
	wire [0:0] tmpINTERRUPT_0__LCD_K_net;
	electrical [0:0] tmpSIOVREF__LCD_K_net;

	cy_psoc3_pins_v1_10
		#(.id("0bcf2213-c012-411b-a3cd-3ba0aec78684"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		LCD_K
		 (.oe(tmpOE__LCD_K_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LCD_K_net[0:0]}),
		  .io({tmpIO_0__LCD_K_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_K_net),
		  .interrupt({tmpINTERRUPT_0__LCD_K_net[0:0]}),
		  .annotation({Net_2}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LCD_K_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
