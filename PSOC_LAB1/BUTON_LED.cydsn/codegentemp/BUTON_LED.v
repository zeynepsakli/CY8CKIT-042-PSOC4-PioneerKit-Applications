// ======================================================================
// BUTON_LED.v generated from TopDesign.cysch
// 03/22/2021 at 21:47
...
module top ;
	...
	wire [0:0] tmpOE__buton_net;
	wire [0:0] tmpFB_0__buton_net;
	wire [0:0] tmpIO_0__buton_net;
	wire [0:0] tmpINTERRUPT_0__buton_net;
	electrical [0:0] tmpSIOVREF__buton_net;
	...
	cy_psoc3_pins_v1_10
		...
		buton
		 (.oe(tmpOE__buton_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__buton_net[0:0]}),
		  .io({tmpIO_0__buton_net[0:0]}),
		  .siovref(tmpSIOVREF__buton_net),
		  .interrupt({tmpINTERRUPT_0__buton_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__buton_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
