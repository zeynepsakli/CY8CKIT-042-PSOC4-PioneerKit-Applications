// ======================================================================
// led_blink_pwm.v generated from TopDesign.cysch
// 03/22/2021 at 21:41
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30\B_PWM_v3_30.v"
`else
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_PWM_v3_30\B_PWM_v3_30.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__LED_board_net;
	wire [0:0] tmpFB_0__LED_board_net;
	wire [0:0] tmpIO_0__LED_board_net;
	wire [0:0] tmpINTERRUPT_0__LED_board_net;
	electrical [0:0] tmpSIOVREF__LED_board_net;
	...
	cy_psoc3_pins_v1_10
		...
		LED_board
		 (.oe(tmpOE__LED_board_net),
		  .y({Net_86}),
		  .fb({tmpFB_0__LED_board_net[0:0]}),
		  .io({tmpIO_0__LED_board_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_board_net),
		  .interrupt({tmpINTERRUPT_0__LED_board_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_board_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("88dc2996-2dc5-4073-855c-464466ca2260"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("3937007874015.75"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_1
		 (.clock_out(Net_61));
